...
class shell1:
    ...
    Конструктор принимает координаты первого снаряда, его радиус, цвет, скорость и направление."""
...
class shell2:
    ...
    Конструктор принимает координаты второго снаряда, его радиус, цвет, направление и скорость."""
...
class Button:
    """
    Класс кнопок.
    Конструктор принимает ширину и высоту кнопки, цвет заливки, эффект заполнения и очистки кнопки цветом.
    """
...
def Bullet1():
    """Функция убирает снаряды дсиплея, если они улетает за границу.
    Функция регистрирует попадание снаряда во первого игрока, убирает снаряд с дисплея и убавляет здоровье."""
    global health2
    for bullet1 in bullets1:
